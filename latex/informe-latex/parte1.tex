...
\textbf{Quiz ``Introduction to Packet Tracer - PT Basics Quiz'' (individual):} cada integrante rindió el quiz y guardó captura del resultado (figuras \ref{fig:quiz} y \ref{fig:quizc}).
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\textwidth]{quiz-camilo-getting-started.jpg}
  \caption{Resultado del quiz Getting Started (Camilo).}
  \label{fig:quizc}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{pt-trabajo-simulador.png}
  \caption{Trabajo de simulación en Packet Tracer.}
  \label{fig:ptsim}
\end{figure}
