# exportar-ovas-v5.ps1 - LOTE FINAL: 6 OVAs restantes (slackware-3, solaris-3, core-3, gui-1/2/3).
# Misma regla: nunca exportar la misma VM en paralelo.
$ErrorActionPreference = 'Continue'
$vbm = 'C:\Program Files\Oracle\VirtualBox\VBoxManage.exe'
$out = 'C:\Users\RANGE\Downloads\maquinas\copias'
$logFile = Join-Path $out 'export-v5.log'
$concurrency = 3
...
Write-Log '=== INICIO lote final v5 ==='
$jobs = @(
    @{ VM = 'slackware-15.0'; N = 3 },
    @{ VM = 'solaris-11.4'; N = 3 },
    @{ VM = 'windows-server-core'; N = 3 },
...
if ($failures.Count -gt 0) { Write-Log "=== FIN con $($failures.Count) fallos ===" } else { Write-Log '=== FIN: lote final OK ===' }
